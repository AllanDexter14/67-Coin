...
module my_coin::my_coin {
    ...
    fun create_currency<T: drop>(
        ...
        let url = url::new_unsafe_from_bytes(b"https://imageio.forbes.com/specials-images/imageserve/68db0c90d4f204b8686325ad/The--67-kid--has-been-transformed-into-a-Lovecraftian-entity-by-the-internet/1960x0.jpg?format=jpg&width=960");
